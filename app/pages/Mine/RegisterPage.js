    ...
    register(){
        if(this.state.userName!==''){
            if(this.state.userPwd!==''){
                fetch('https://leopord.cn/registerUser', {
                    method: 'POST',
                    mode:'cors',
                    headers: {
        ...
                        'Content-Type': 'application/json',
                ...
                .then((responseData) => { // 上面的转好的json
                    if(responseData.code==1){
                        ToastAndroid.showWithGravity('注册成功，请重新登录',ToastAndroid.SHORT,ToastAndroid.CENTER);
                        setTimeout(() => {
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.btnStyle}>
                    <Text style={styles.loginText} onPress={()=>this.register()}>立即注册</Text>
                </TouchableOpacity>
