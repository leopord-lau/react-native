...
export  default  class MineScreen extends React.Component {
    constructor(props){
        ...
        this.state = {
            ...
            dataSource:[
                {title:'我的收藏',details:'',icon:require('../../images/ic-mine-sc.png'),next:''},
                {title:'我的客服',details:'',icon:require('../../images/ic-mine-kf.png'),next:''},
                {title:'推荐有奖',details:'得15元',icon:require('../../images/ic-mine-tjyj.png'),next:''},
