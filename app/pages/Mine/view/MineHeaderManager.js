...
export  default class MineHeaderView extends React.Component {
    constructor(props){
        ...
        this.state = {
            redPcket:[
                {title:'订单',count:'20',subText:'未接单'},
                {title:'配送',count:'20',subText:'正在配送'},
                {title:'完成',count:'130',subText:'个订单'},
            ]
        }
    }
    render() {
        return (
            <View style={styles.container}>
                ...
                <View style={styles.user}>
                    <Image style={styles.userImage} source={{uri:'https://cube.elemecdn.com/b/b5/1cfd09539c63113f198296c0e9234png.png'}}/>
                    <View style={styles.userlogin}>
                        <Text  style={styles.userName}>{this.props.userName}</Text>
                        <Text  style={styles.userPhone}>{this.props.usePhone}</Text>
                    </View>
                    <Image style={styles.nextIcon} source={require(`../../../images/ic-list-item-next.png`)}/>
                </View>
                </TouchableOpacity>
