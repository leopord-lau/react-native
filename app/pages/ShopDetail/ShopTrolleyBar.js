        ...
        return (
            ...
            <View style={[{flexDirection:'row',alignItems:'center',backgroundColor:'#3D3D3F',height:44},this.props.style]}>
                ...
                <TouchableOpacity onPress={()=>{this.props.goPay&&this.props.goPay()}}
                    ...
                    <Text style={{color:this.props.data&&this.props.data.total>0?'#fff':'#bbb',fontSize:16,fontWeight:'500'}} onPress={()=>this.pay()}>{this.props.data&&this.props.data.total>0?'去结算':`${this.props.data.sendOutUp}元起送`}</Text>
                </TouchableOpacity>
            </View>
        );
    }
