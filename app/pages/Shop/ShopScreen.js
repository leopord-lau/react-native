...
import ShopScreen1 from './ShopScreen1'
...
let navigation={};
 ...
 class ShopScreen extends Component{
  ...
  constructor(props){
    ...
    this.jumpDetail1=this.jumpDetail1.bind(this)
  }
      ...
      <ScrollView style={styles.container}>
        ...
        <TitleCell title='猜你喜欢' iconSrc="icon_shop_cnxh"/>
          {this.state.shopList.map(
            (item,index)=> <ShopBar key={index} data={item} onClick={this.jumpDetail1}/>
          )}
      </ScrollView>
    )
  }
  ...
  jumpDetail1(url){
    navigation.navigate('Inside',url);
  }
  fetchShopList(){
...
function ShopHeader() {
  return(
    <View style={styles.header}>
      <Text style={styles.headerText}>美食</Text>
    </View>
  )
}
*/

export default ShopStack=createSwitchNavigator(
  {
    Shop:{screen:ShopScreen},
    Detail:{screen:ShopDetail},
    Inside:{screen:ShopScreen1}
  },
  {
    navigationOptions:{
      title:'美食',
