...
import LocalImg from '../../images/bg.jpg'
...
export default class ShopInside extends Component {
  constructor(props){
    super(props)
    this.state = {
      scrollY: 0,
      ...
      <Animated.View style={[styles.topView, style]}>
        <View style={{
          ...
          <ScrollableTabView page={0}  renderTabBar={() => <TabViewBar/>}>
            <GoodsList ref="goodsList" minus={this.minusItem.bind(this)} lens={this.state.lens} goods={this.state.goods} onAdd={this.onAdd.bind(this)} headHeight={marginTop}/>
            <Comments headHeight={marginTop} />
          </ScrollableTabView>
          </View>
      </Animated.View>
      </View>
  ...
  render(){
    ...
    return (
      <View style={{flex: 1, backgroundColor: "#f3f3f3"}}>
        <Animated.Image source={LocalImg} ref={'backgroundImage'} onLoadEnd={this.imageLoaded.bind(this)} style={[
          styles.bg,
          {
        ...
        <View style={styles.head}>
          <Animated.View style={{flexDirection: "row", paddingHorizontal: 16, opacity: this.state.headOpacity}}>
            <Image source={LocalImg} style={styles.logo}/>
