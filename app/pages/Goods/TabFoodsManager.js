...
import  ShopRecommendManager from './ShopRecommandManager'
import  ShopFoodListManager from './ShopFoodListManager'

export  default class TabFoodsManager extends React.Component {
    ...
    renderRecommends(RecommendHeight) {
        if (this.props.recommends.length>0){
            ...
            let ItemMargin = 5;
            let Cols = 3;
            let ItemWidth = (Dimensions.get('screen').width-2*ItemEdge-(Cols-1)*ItemMargin)/Cols;
            let TitleHeight = 30;
        ...
        return(
            <SectionList
                ...
                renderItem={({ item, index, section,separators }) => {
                    ...
                    return <ShopFoodListManager model={item}
                                             reduceButtonOnPress={()=>{
